  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Note: Depending on your Supabase settings, the user might be
        // automatically signed in after sign up or might need to confirm email
        if (data?.user && !data?.session) {
          // User needs to verify email before being signed in
          setMessage(t('auth.check_email'));
